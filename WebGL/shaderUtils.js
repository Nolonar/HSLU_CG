 ...
 */
async function loadAndCompileShaders(gl, vertexShaderFileName, fragmentShaderFileName) {
    const vertexShaderSource = await loadResource(vertexShaderFileName);
    const fragmentShaderSource = await loadResource(fragmentShaderFileName);
